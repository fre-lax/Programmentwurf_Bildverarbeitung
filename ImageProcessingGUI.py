...
class ImageWidget(QLabel):
    ...
    def __init__(self, parent=None):
        ...
        # make sure, the picture is shown correctly on screens with different DPI
    ...
    def updateView(self):
        ...
        scale=self.scale*self.scale_percent*10
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Image Processing GUI v.2.0 - "+self.config['folder'])
